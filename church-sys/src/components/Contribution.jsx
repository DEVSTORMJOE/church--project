...
function Contributions() {
  ...
  return (
    <div className="cont mt-32">
      <div className="relative overflow-x-hidden bg-gray-50 min-h-screen py-10 px-6 md:px-20">
       

        {/* Payment Options */}
        <div className="text-center mb-8">
          <h3 className="text-2xl md:text-3xl font-bold text-blue-700 mb-4 animate-fadeIn">
            Make a Contribution
          </h3>
          <p className="text-gray-600 text-md md:text-lg animate-fadeInDelay">
            Choose your preferred payment method for tithes, offerings and other contributions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 text-center animate-fadeInDelay2">
            <PhoneCall size={48} className="text-blue-500 mx-auto mb-4" />
            ...
            <button
              ...
              className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-full font-bold transition-all duration-300"
            >
              Contribute Now
            </button>
          </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-8 rounded-xl shadow-lg w-[90%] max-w-md relative animate-fadeIn">
              ...
              <div className="flex flex-col gap-4">
                ...
                <button className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-full font-bold transition-all duration-300">
